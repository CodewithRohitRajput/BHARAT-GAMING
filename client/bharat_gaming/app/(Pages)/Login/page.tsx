...
export default  function Signup() {
  ...
  <form className="glitch-card"  >
    ...
    <div className="card-body">
      ...
      <button data-text="LOGIN" type="submit" onClick={handleSubmit} className="submit-btn">
        <span className="btn-text">LOGIN</span>
      </button>
    </div>
    <h1 className="text-center mt-5 mb-4" >Do not have an account? <Link href='/Signup'> <span className="text-cyan-500 animate-pulse" > Signup </span> </Link>  </h1>
  </form>
</div>
